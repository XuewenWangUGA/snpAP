...
{
	public:
		VCFfac_GL( ifstream &in_, /* FastaSlurp &fa_, */ Error &e_, vector<double> &priors_, const char* sample_name_, double ref_bias_=0. ) : in(in_), /* fa(fa_), */ e(e_), 
									priors(priors_), sample_name(sample_name_), eof(0), PP( 10, 0 ), GL( 10, 0. ), log_gt( 10, 0. ), 
									basesfwd( 4, 0 ), basesrev( 4, 0 ), ref_bias( ref_bias_ ) 
			{ next() ; } ;
